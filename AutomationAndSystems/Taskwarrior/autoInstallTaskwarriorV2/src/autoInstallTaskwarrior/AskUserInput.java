...
//		reader.close();
	...
	/**
	 * TODO: Test method TODO: add in code tests(not unit tests) in cases that
...
//			}
	...
	public static String requestDriveLetter() {
		...
		Scanner reader = new Scanner(System.in); // Reading from System.in
		System.out.println(
				"I would like to make a folder to copy your certificates and backups to, so that you can easily copy them to your other devices."
						+ '\n' + '\n'

...
public class MainActivity extends AppCompatActivity {
     ...
     *
     *  Methods:
     *  0. getAccountList0() - it succesfully loops through all the accounts on the phone, has filter
     *  that only passes the davdroid accounts on to the removal methods.
     *  1. writeToFile() it is a method to allow for debugging, it returns pop up messenges during
     *  code execution.
     *  2. method removeAccounts0() it removes acocunts with command removeAccountsExplicitly
     *  3. removeAccounts1(); it removes accounts with the removeAccount method(API level <22)
     *  4. removeAccounts2(); it removes accounts with the removeAccount method (API level>22)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getAccountList0();
                removeAccounts0(); //This should be sufficient to remove the accounts, but it does not do so.
    ...
    public void removeAccounts0(){
        ...
        for (int index = 0; index < Temp; index++) {
            ...
            if (accounts[index].type.intern() == AUTHORITY) {
                ...
                removeAccount0(accountManager, accounts[index]);
                removeAccount1(accountManager, accounts[index]);
                removeAccount2(accountManager, accounts[index]);
            }
        }
    }
    ...
    public void removeAccount0(AccountManager accountManager ,Account removalAccount){
        accountManager.removeAccountExplicitly(removalAccount);
    }

    public void removeAccount1(AccountManager accountManager ,Account removalAccount){
        accountManager.removeAccount(removalAccount, null, null);
    }

    public void removeAccount2(AccountManager accountManager ,Account removalAccount){
